  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        Locate the downloaded file named <code className="text-xs bg-surface-2 px-1.5 py-0.5 rounded text-foreground font-mono">nudigo-extension-v2.zip</code> in your Downloads folder.
      </p>
      ...
      <div className="flex items-center justify-center gap-3 py-2">
        ...
        <div className="w-16 h-20 rounded-xl border-2 border-primary/30 bg-primary/5 flex flex-col items-center justify-center">
          ...
          <span className="text-[9px] text-primary mt-1">nudigo-extension-v2</span>
        </div>
      </div>
    </div>
  );
