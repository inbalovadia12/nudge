    ...
    <div className="space-y-4">
      ...
      <ol className="space-y-3 text-sm text-muted-foreground">
        ...
        <li className="flex gap-3">
          ...
          Select the extracted folder named <code className="text-xs bg-surface-2 px-1.5 py-0.5 rounded text-foreground font-mono">vesper-extension</code>.
        </li>
        <li className="flex gap-3">
      ...
      <div className="rounded-xl border-2 border-dashed border-primary/30 bg-primary/5 p-4">
        ...
        <div className="flex items-center gap-3 bg-card rounded-lg border border-border p-3">
          ...
          <div>
            <p className="text-sm font-semibold text-foreground">vesper-extension</p>
