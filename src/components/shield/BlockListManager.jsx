  ...
  return (
    <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">
              {screenTimeConnected
                ? 'Connected — block list syncs to your device via the Nudigo iOS companion app'
      ...
      <div className="rounded-2xl border border-warning/30 bg-warning/5 p-4 mb-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-xs font-medium text-foreground mb-0.5">Blocking works within Nudigo</p>
          <p className="text-xs text-muted-foreground">This blocklist intercepts sites when you check them through Nudigo's URL checker. To block sites across your entire browser or device, connect Apple Screen Time above or use a browser extension.</p>
        </div>
      </div>
      ...
      {showBlocked && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowBlocked(null)}>
          <div className="bg-card rounded-2xl border border-border p-6 max-w-sm w-full text-center" onClick={e => e.stopPropagation()}>
            ...
            <h3 className="text-lg font-bold mb-2">Blocked by Nudigo</h3>
