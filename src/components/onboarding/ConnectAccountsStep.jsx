...
export default function ConnectAccountsStep({ connections, onToggle, onBack, onContinue }) {
  return (
    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
      ...
      <p className="text-muted-foreground mb-6">Optional, but it makes Nudigo much smarter. You can skip for now.</p>
      ...
      <div className="flex items-center gap-2 mb-6 text-xs text-muted-foreground">
        ...
        <span>Bank-level encryption. Nudigo never stores your credentials.</span>
      </div>
