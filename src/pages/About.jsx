...
export default function About() {
  useSeo({
    title: 'About Thryve — Why We Built a Simpler Finance App',
    description: 'Thryve was built to make money management simple for beginners and young adults. Learn about our mission to replace complex budgeting with sustainable habits.',
  });
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-3xl font-bold font-heading text-foreground mb-4">About Thryve</h1>
        </motion.div>

        <div className="prose prose-invert prose-sm max-w-none space-y-5 text-muted-foreground leading-relaxed">
          <p>
            Thryve started with a simple observation: most personal finance apps are built for people who already love spreadsheets. They assume you know what a "category" is, that you'll log every coffee, and that you'll stick to a rigid budget month after month.
          </p>
          <p>
          ...
          <p>
            Instead of complex budgets, Thryve focuses on habits: small, sustainable actions that add up over time. Track your spending, set goals that matter to you, get honest guidance when you need it, and build confidence with every small win.
          </p>
          ...
          <p>
            So we built Thryve to be the middle ground — powerful enough to actually help, simple enough that you'll actually use it.
          </p>
          ...
          <div className="grid gap-4 not-prose py-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Not for accountants. If you've never been taught how to manage money, Thryve is designed for you.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
          ...
          <p>
            Ready to take control of your money without the overwhelm? Thryve is free to start. No credit card, no commitment, no judgment.
          </p>
