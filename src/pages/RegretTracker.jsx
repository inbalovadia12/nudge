  ...
  if (!isPremium) {
    return (
      <div className="p-6 max-w-2xl mx-auto pb-24 lg:pb-6">
        ...
        <p className="text-sm text-muted-foreground mb-6">One week after each purchase, Nudge checks in. Over time, it learns what actually brings you joy.</p>
        <PaywallCard title="Learn from your spending" description="Regret tracking trains Nudge's AI to recognize patterns — so it can warn you before the next purchase you'll regret." onUpgrade={() => {}} />
      </div>
    );
  }
