    ...
    return (
      <div className="p-6 max-w-2xl mx-auto pb-24 lg:pb-6">
        ...
        <PaywallCard
          ...
          description="After 60 days of data, Nudge generates a detailed personality profile from your actual behavior — strengths, vulnerabilities, and personalized suggestions."
          onUpgrade={() => {}}
        />
      </div>
    );
